# Convex Hull algorithm using Divide and Conquer
import random
import math
...
points = []
while len(points) <= 15: # make random coordinates of plane that doesnt count duplicates
  new_coordinates = []
  x = random.randint(1, 100)
  y = random.randint(1, 100)
  new_coordinates.append(x)
  new_coordinates.append(y)
  if new_coordinates not in points:
    points.append(new_coordinates)
